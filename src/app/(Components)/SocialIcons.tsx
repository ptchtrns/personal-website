...
export default function SocialIcons () {
  return(
    <>
      ...
      <Link href="https://www.fiverr.com/ptchtrns/design-and-code-a-website" target="_blank" className="inline-block opacity-80 hover:opacity-90 mr-2"><Image src="/images/fiverr.svg" height={23} width={23} alt="Fiverr icon" className="dark:invert" /></Link>
    </>
  )
}