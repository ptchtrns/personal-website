  ...
  return (
    <div className="px-8 lg:px-12">
      ...
      <div className="flex flex-col xl:flex-row">
        <ProjectElement img="/images/simpictures.svg" href="https://linktr.ee/simpictures" linkText="Follow" title="SimPictures" text="Think of it as the Instagram for virtual aviation enthusiasts, where you can effortlessly share captivating photos, discover breathtaking flights, and establish yourself as a prominent third-party scenery, plane, or addon developer in the flight sim community." />
