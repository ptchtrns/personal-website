      ...
      <Link href={href} target="_blank" rel="noopener noreferrer" className="flex flex-1">
        <div className="flex items-top py-8 project-element">
          <div className="flex-none">
            <Image src={img} alt="Nikolai's personal project" width={100} height={100} className="opacity-80 project-element-image w-[50px] md:w-[100px] mt-3 dark:!invert" style={{ objectFit: "cover" }} />
          </div>
